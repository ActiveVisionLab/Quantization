...
path_checkpoints = "/home/marcelo/checkpoints_CIFAR10/"
...
class ResNet18(ResNet):
    ...
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            self.load_state_dict(torch.load(path_checkpoints + "resnet18.pth"))
...
class ResNet34(ResNet):
    ...
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            self.load_state_dict(torch.load(path_checkpoints + "resnet34.pth"))
...
class ResNet50(ResNet):
    ...
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            self.load_state_dict(torch.load(path_checkpoints + "resnet50.pth"))
...
class ResNet101(ResNet):
    ...
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            self.load_state_dict(torch.load(path_checkpoints + "resnet101.pth"))
...
class ResNet152(ResNet):
    ...
    def __init__(self, pretrained=False):
        ...
        if pretrained:
            self.load_state_dict(torch.load(path_checkpoints + "resnet152.pth"))
