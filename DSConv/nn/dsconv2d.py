...
class DSConv2d(_ConvNd):
    '''
    The difference between this and the Conv2d module is the bit and block_size arguments.
    ...
    def quantize(self):
        ...
        (self.quant_w,
         self.intw,
         self.alpha) = self.__quantize__(self.weight, self.blk, self.bit, self.nmb_blk)
